...
class Res2Net(nn.Module):
    ...
    def __init__(self, block, C, model_scale, nOut, n_mels, log_input, encoder_type, context=False, summed=False,
                 out_bn=False, **kwargs):
        ...
        self.torchmfcc = torch.nn.Sequential(
            PreEmphasis(),
            torchaudio.transforms.MFCC(sample_rate=16000, n_mfcc=self.n_mfcc, log_mels=self.log_input, dct_type=2,
                                       melkwargs={'n_mels': 80, 'n_fft': 512, 'win_length': 400, 'hop_length': 160,
